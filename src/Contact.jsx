    ...
    <div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-center mb-12 text-dark">Contact Us</h1>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl font-bold mb-6 text-primary">Get In Touch</h2>
              <p className="text-gray-600 mb-8">
                Have questions about a property or our services? Fill out the form and our team will get back 
            ...
            <div>
              <h2 className="text-2xl font-bold mb-6 text-primary">Our Offices</h2>
